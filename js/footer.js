    ...
    connectedCallback() {
      this.innerHTML = `
          ...
          <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
              <div class="col mb-3">
                  <img src="/fitness2/certificate/img/Fitness2_logo.PNG" class="rounded mx-auto d-block" alt="" width="90%" height="auto">
                  <img src="/fitness2/certificate/img/Erasmus-Logo-sans-fond-1-uai-1032x212.png" class="rounded mx-auto d-block" alt=""
